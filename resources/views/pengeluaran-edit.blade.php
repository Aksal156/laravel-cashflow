                    ...
                    <div class="card-body">
                        <form action="/pengeluaran/{{ $item->id }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="teks" class="form-control" placeholder="input keterangan" name="keterangan"
                            ...
                            <div class="row mb-4 col-5 m-auto">
                                <a href="/pengeluaran"><button class="btn btn-success" type="submit">Update</button></a>
                            </div>
                        </form>
                    </div>
                </div>
